pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'tameemahmed/pet-clinic-1.0.1'  // Name for the Docker image
            ...
            steps {
                script {
                                   ...
                                   sh """
                                       ...
                                       ssh -i ${PRIVATE_KEY_PATH} ${EC2_USER}@${EC2_IP} 'sudo docker run -d --name tameemahmed/pet-clinic-1.0.1:latest -p ${PET_CLINIC_PORT}:9091 --network=bootApp \
